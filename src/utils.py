...
def generate_svg(
    ...
    username_svg = f"""<a href="{profile_url}" target="_blank"> <text x="100" y="35" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="16" font-weight="bold">{username}</text> </a>"""
    if league:
        league_svg = f"""<image href="{LEAGUES_SVG_B64[league.lower()]}" x="100" y="50" width="30" /><text x="135" y="63" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="11">{league} league</text>"""
    else:
        league_svg = f"""<text x="100" y="63" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="11">No league</text>"""
    if title:
        ...
        joined_svg_y = 35
        last_seen_svg_y = 50
    joined_svg = f"""<text x="280" y="{joined_svg_y}" fill="{colors["text-light"]}" font-family="Arial, sans-serif" font-size="10">Joined: {joined}</text>"""
    last_seen_svg = f"""<text x="280" y="{last_seen_svg_y}" fill="{colors["text-light"]}" font-family="Arial, sans-serif" font-size="10">Last seen: {last_seen}</text>"""
    if rapid_stats:
        rapid_section = f"""<rect x="10" y="100" width="120" height="150" fill="{colors["fg"]}" rx="8" ry="8" /> <image href="{TIME_RAPID_SVG_B64}" x="30" y="112" width="25" /> <text x="80" y="130" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="14" font-weight="bold" text-anchor="middle">Rapid</text> <text x="70" y="160" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="22" font-weight="bold" text-anchor="middle">{rapid_stats["last"]["rating"]}</text> <text x="70" y="185" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="12" text-anchor="middle">Highest</text> <text x="70" y="200" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="14" text-anchor="middle">{rapid_stats["best"]["rating"]}</text> <text x="70" y="225" font-family="Arial, sans-serif" font-size="11" text-anchor="middle"> <tspan fill="{colors["win"]}">{rapid_stats["record"]["win"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["draw"]}">{rapid_stats["record"]["draw"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["loss"]}">{rapid_stats["record"]["loss"]}</tspan> </text>"""
    if blitz_stats:
        blitz_section = f"""<rect x="140" y="100" width="120" height="150" fill="{colors["fg"]}" rx="8" ry="8" /> <image href="{TIME_BLITZ_SVG_B64}" x="165" y="112" width="25" /> <text x="208" y="130" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="14" font-weight="bold" text-anchor="middle">Blitz</text> <text x="200" y="160" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="22" font-weight="bold" text-anchor="middle">{blitz_stats["last"]["rating"]}</text> <text x="200" y="185" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="12" text-anchor="middle">Highest</text> <text x="200" y="200" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="14" text-anchor="middle">{blitz_stats["best"]["rating"]}</text> <text x="200" y="225" font-family="Arial, sans-serif" font-size="11" text-anchor="middle"> <tspan fill="{colors["win"]}">{blitz_stats["record"]["win"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["draw"]}">{blitz_stats["record"]["draw"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["loss"]}">{blitz_stats["record"]["loss"]}</tspan> </text>"""
    if bullet_stats:
        bullet_section = f"""<rect x="270" y="100" width="120" height="150" fill="{colors["fg"]}" rx="8" ry="8" /> <image href="{TIME_BULLET_SVG_B64}" x="295" y="115" width="23" /> <text x="340" y="130" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="14" font-weight="bold" text-anchor="middle">Bullet</text> <text x="330" y="160" fill="{colors["text-bright"]}" font-family="Arial, sans-serif" font-size="22" font-weight="bold" text-anchor="middle">{bullet_stats["last"]["rating"]}</text> <text x="330" y="185" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="12" text-anchor="middle">Highest</text> <text x="330" y="200" fill="{colors["text-mid"]}" font-family="Arial, sans-serif" font-size="14" text-anchor="middle">{bullet_stats["best"]["rating"]}</text> <text x="330" y="225" font-family="Arial, sans-serif" font-size="11" text-anchor="middle"> <tspan fill="{colors["win"]}">{bullet_stats["record"]["win"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["draw"]}">{bullet_stats["record"]["draw"]}</tspan> <tspan fill="{colors["text-mid"]}">/</tspan> <tspan fill="{colors["loss"]}">{bullet_stats["record"]["loss"]}</tspan> </text>"""
    svg = "".join(
        [
